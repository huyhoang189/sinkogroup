...
<!-- <marquee direction="left" behavior="scroll" scrolldelay="5" scrollamount="5" onmouseover="this.stop();" onmouseout="this.start();"  align="top"><span class="cau-chao">Trang thông tin điện tử xã Quảng Bàng - Tình Ninh Thuận</span></marquee> -->
